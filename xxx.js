...
for(var j=0;j<canvases.length;j++){ 
    ...
    for (var i = 0; i < 5; i++) {   
        ...
        context.lineTo(Math.cos((18+i*72)/180*Math.PI)*12.5/2+10,  
                        -Math.sin((18+i*72)/180*Math.PI)*12.5/2+32);   
        ...
        context.lineTo(Math.cos((54+i*72)/180*Math.PI)*5/2+10,   
                        -Math.sin((54+i*72)/180*Math.PI)*5/2+32);   
